...
كون من هالمجال 3 تحديات وكلها ترتبط في بعض والمطلوب منك عشان تحل التحديات حسب كل وصف لكل تحدي تبحث في الإنترنت وعلى وجه الخصوص الموقع الشهير اللي ذكرته سابقًا "MITRE ATT&CK" لأنه يجمع كل تكنيكات المخترقين الشهيرة بشرح تفصيلي و أرقام و دلائل تعريفيه لها ونستخرج من هالمصدر الحل على صيغة فلاق FlagBSF{example} :

# إسم التحدي : intelligence 1
وصف التحدي : أنت إعترضت بريد إلكتروني تم إرساله لأحد المسؤولين التنفيذيين في الشركة يحتوي على رابط مشبوه, هذا البريد الإلكتروني على ما يبدو أنه جزء من هجوم تصيد إحتيالي مستهدف, هل تستطيع أن تعرف و تحلل أي جزء فرعي من هذه التكنيكات هو المستخدم في هذا السينارو؟

![intelligence 1 chall photo](https://github.com/0x1o1/BSF24-CTF/assets/112539392/6a090914-e37f-4b46-b130-05825dcbda32)

أولاً علينا معرفة الهجوم وكما هو مذكور "تصيد إحتيالي أو Phishing" لذلك علينا فتح موقع "MITRE ATT&CK" عن طريق الرابط : https://attack.mitre.org/ لأنه من أفضل المراجع لـ مثل هذه الهجمات , و لابد من أن نعرف أن أسلوب التصيد الإحتيالي هو أحد أساليب جمع المعلومات والمغزى منه جمع المعلومات ولكن بشكل "فعال - Active" أي التواصل المبار مع الهدف , وتندرج في موقع    "MITRE ATT&CK" تحت جزء الـ "إستطلاع أو Reconnaissance" كما في الصورة الآتية :
...
يمكننا أن نرى أن هنالك 4 تكنياكات فرعية وكما هو مذكور في وصف التحدي أنه تكنيك فرعي لذلك نضغط على منطة السهم المحدد بالدائرة الحمراء وتظهر لنا التكنيكات الفرعية التالية :

![spear](https://github.com/0x1o1/BSF24-CTF/assets/112539392/e87ea9d1-47c5-4916-874e-dc807fc3e628)

وكما هم مذكور في وصف التحدي أن الهجوم كان عن طريق رابط مشبوه وهنا يوجد 4 أنواع من التكنيكات واحد منها فقط الخاص بالروابط هذا يعني أننا وصلنا للحل الصحيح.
