...
هنا نستخدم القاعدة المهمة االي ذكرناها قبل شوي ( راح يتم إنشاء ملف البريفيتش بعد التنفيذ أو الشغيل بـ 10 ثواني ) وننقص 10 ثواني من الوقت اللي طالع لنا هنا :

![last runt time](https://github.com/0x1o1/BSF24-CTF/assets/112539392/76919d76-5778-4989-8377-f51c51444a82)

زس ما أنتم شايفين الوقت اللي قدامنا هو:
