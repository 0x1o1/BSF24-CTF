...
هنا بعد ما تعلمنا كيف نفلتر البيانات و نشوف فقط أي شيء متعلق بدليل يوجد لدينا مثل الـ"IP" الخاص بالمهاجم ممكن نبدأ نتصفح "الحزم - Packets" واحده تلو الأخرى بحثًا عن بيانات تم نقلها عن طريق الشبكة ممكن نضغط زر الفأرة الأيمن ثم "تابع - Follow" ثم "عرض UDP Stream - UDP" كما هو موضح في الصورة التالية :

![pic to solve chall 3 - 1](https://github.com/0x1o1/BSF24-CTF/assets/112539392/d374bfbd-b5ea-4721-b65e-711e270323b6)

بعد كذا رايح يظهر لنا بشكل مباشر الفلاق كما هو واضح في الصورة التالية :
